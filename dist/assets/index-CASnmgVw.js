(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(e){if(e.ep)return;e.ep=!0;const r=s(e);fetch(e.href,r)}})();async function i(){try{const t=await fetch("https://script.google.com/macros/s/AKfycbywBVkwIuqroRN0tyv_ZOVkDZIocopYU7LhxjOVLRp321fB1OYQ9R7V-ORna7_pLsoR/exec");console.log("RESPONSE",t);const s=await t.json();console.log("EVENTOS",s);const o=document.getElementById("eventos");if(!o)return;o.innerHTML="",s.forEach(e=>{const r=document.createElement("li");r.className=`
      ...
      `,o.appendChild(r)})}catch(c){const t=document.getElementById("eventos");t&&(t.innerHTML='<p class="text-red-500 font-semibold text-center">Error al cargar eventos 😢</p>'),console.error("Error al cargar el archivo JSON:",c)}}i();
